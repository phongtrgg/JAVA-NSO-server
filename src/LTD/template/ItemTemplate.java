...
public class ItemTemplate {
    ...
    public static int MAX_ST_NGUOI = 2000;
    public static int MAX_ST_QUAI = 5000;
    public static int HP_TOI_DA = 10000;
    public static int MP_TOI_DA = 5000;
    public static int CHI_MANG = 100;
    public static int KHANG_ST_CHI_MANG = 25;
    public static int MOI_GIAY_HOI_PHUC_HP = 200;
    public static int MOI_GIAY_HOI_PHUC_MP = 200;
    public static int MAX_TAN_CONG = 5000;
    public static int GIAM_TRU_ST = 500;
    public static int PHAN_DON = 100;
    public static int ST_CHI_MANG = 5000;
    public static int CHINH_XAC = 400;
    public static int NE_DON = 400;
    public static int KHANG_TAT_CA = 100;
    ...
    public static void divedeItem(Player p, Message m) throws SQLException, InterruptedException {
        try {
            ...
            if (quantity > 0 && item != null && item.quantity > 1 && quantity <= item.quantity) {
                if (item.quantity > 50000) {
                    p.conn.sendMessageLog("item quá 50k SL ko thể tách");
                    return;
                }
            }
            {
            ...
            e.printStackTrace();
            p.conn.sendMessageLog("Tạm biệt bạn nhé!");
            int TimeSeconds = 2;
            while (TimeSeconds > 0) {
                TimeSeconds--;
                Thread.sleep(1000);
            ...
            p.lockAcc();
            System.out.println("Khóa acc: " + p.c.name + " Vì Bug Item");
        } finally {
            if (m != null) {
                m.cleanup();
            }
