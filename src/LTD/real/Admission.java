    ...
    public static void Admission(Player player, byte nclass) {
        ...
        switch(nclass) {
            ...
            case 6:
                ...
                break;
          case 7:
                item = ItemTemplate.itemDefault(1025, true);
                item.sys = 0;
                player.c.addItemBag(true, item);
                player.c.addItemBag(true, ItemTemplate.itemDefault(1016, true));
                break;
          case 8:
                item = ItemTemplate.itemDefault(1035, true);
                item.sys = 0;
                player.c.addItemBag(true, item);
                player.c.addItemBag(true, ItemTemplate.itemDefault(1027, true));
                player.c.addItemBag(true, ItemTemplate.itemDefault(1028, true));
                player.c.addItemBag(true, ItemTemplate.itemDefault(1029, true));
                player.c.addItemBag(true, ItemTemplate.itemDefault(1030, true));
                player.c.addItemBag(true, ItemTemplate.itemDefault(1031, true));
                player.c.addItemBag(true, ItemTemplate.itemDefault(1032, true));
                player.c.addItemBag(true, ItemTemplate.itemDefault(1033, true));
                player.c.addItemBag(true, ItemTemplate.itemDefault(1034, true));
                 break;
           case 9:
                item = ItemTemplate.itemDefault(1036, true);
                item.sys = 0;
                player.c.addItemBag(true, item);
                player.c.addItemBag(true, ItemTemplate.itemDefault(1037, true));
                player.c.addItemBag(true, ItemTemplate.itemDefault(1045, true));
                player.c.addItemBag(true, ItemTemplate.itemDefault(1044, true));
                break;
        }
        ...
        try {
            ...
            m.writer().writeShort((short)player.c.get().potential0);
            m.writer().writeShort((short)player.c.get().potential1);
            m.writer().writeInt((int)player.c.get().potential2);
            m.writer().writeInt((int)player.c.get().potential3);
            m.writer().writeByte(player.c.get().nclass);
            m.writer().writeShort((short)player.c.get().spoint);
            m.writer().writeShort((short)player.c.get().ppoint);
            m.writer().flush();
