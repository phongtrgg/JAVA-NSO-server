...
public class Player extends User {
    ...
    public long time_attack;
    public long time_attack_player;
    ...
    public void passatm() throws InterruptedException { // code by vu huy dat
        ...
        try {
            ...
            Service.chatKTG("Người Chơi" + c.name + " đã đăng kí ATM ! hãy đi đăng kí ngay <3 .");
            upluongMessage(-20000L);
            this.conn.sendMessageLog("đặt mật khẩu atm thành công");
            this.c.matkhauatm++;
        } catch (SQLException e) {
    ...
    public void lstachdo(String name1, Short idvp, int sltrc, int slsau) {
        try {
            ...
            this.dateFormatFile = new SimpleDateFormat(DATE_FORMAT_FILE);
            String str = Util.toDateString(Date.from(Instant.now()));// ls 
    ...
    public void tanghoaxanh() throws IOException, SQLException {
...
// tạo hàm 
    ...
    public void tanghoavang() throws IOException, SQLException {
        this.updateExp(1000000L);
        this.c.diemhoavang++;
...
// tạo hàm 
    ...
    public void tanghoado() throws IOException, SQLException {
        this.updateExp(1000000L);
...
// tạo hàm
    ...
    public void tanggiohoa() throws IOException, SQLException {
        ...
        try {
            synchronized (Server.LOCK_MYSQL) {
                ...
                if (red != null && red.first()) {
                    ...
                    String passatm = red.getString("passatm"); // vuLTD
                    ...
                    if (status == 1) {
                        ...
                        conn.sendMessageLog("Tài khoản của bạn đã bị khoá do cố gắng làm trò con bò!!");
                        return null;
                        ...
                        for (Session conn1 : Client.gI().conns) {
                                if (conn1 != null && conn.socket.getInetAddress().getHostAddress().equalsIgnoreCase(conn1.socket.getInetAddress().getHostAddress())) {
                                if (conn1.player != null && !name.contains(conn1.player.username)) {
                                    name.add(conn1.player.username);
                                }
                            }
                        }
                        int songuoi = Client.gI().conns_size();
                        if (songuoi > 1000) {
                            conn.sendMessageLog("Máy chủ hiện đã đủ số lượng người chơi [1000/1000], vui lòng thử lại sau ít phút");
                        }
                        if (name.size() >= 3 && !name.contains(user)) {
                            conn.sendMessageLog("Mỗi IP chỉ được login tối đa 3 tài khoản");
                            return null;
                        }
    ...
    public void sendInfo() {
        ...
        try {
            ...
            m.writer().writeShort((short)this.c.ppoint);
            m.writer().writeShort((short)this.c.potential0);
            m.writer().writeShort((short)this.c.potential1);
            m.writer().writeInt((int)this.c.potential2);
            m.writer().writeInt((int)this.c.potential3);
            m.writer().writeShort((short)this.c.spoint);
    ...
    public void loadSkill() {
        ...
        try {
            ...
            m.writer().writeShort((short)this.c.get().spoint);
    ...
    public void restPpoint() {
        ...
        int usePlusPpoint = (8 - this.c.get().useTiemNang) * 10 + (10 - this.c.get().useBanhBangHoa) * 10 + (4 - this.c.tntrung) * 20;
    ...
    public void restSpoint() {
        ...
        int usePlusSpoint = 8 - this.c.get().useKyNang + (10 - this.c.get().useBanhPhongLoi) + (4 - this.c.kntrung);
    ...
    public void loadPpoint() {
        ...
        try {
            ...
            m.writer().writeInt(this.c.get().getMaxHP());
            m.writer().writeInt(this.c.get().getMaxMP());
            m.writer().writeShort((short)this.c.get().ppoint);
            m.writer().writeShort((short)this.c.get().potential0);
            m.writer().writeShort((short)this.c.get().potential1);
    ...
    public boolean updateSysMountsPHB() {
        ...
        if (item == null) {
            ...
            if (20 / (item.sys + 1) > Util.nextInt(115)) {
                ...
                this.loadMounts();
                this.c.p.sendAddchatYellow("Nâng cấp thành công, chim tăng thêm 1 sao");
            } else {
                this.c.p.sendAddchatYellow("Nâng cấp thất bại, hao phí 5 mảnh vỡ");
            }
            return true;
        }
    }
    ...
    public boolean updateXpMounts(int xpup, byte type) {
        ...
        if (item == null) {
            ...
            return false;
        } else if (type == 3 && item.id != 828) {
            this.c.p.sendAddchatYellow("Chỉ sử dụng cho phượng hoàng băng");
            return false;
        } else if (item.upgrade >= 119 && item.id == 828) {
            this.c.p.sendAddchatYellow("Thú cưỡi đã đạt cấp tối đa");
            return false;
        } else if (item.upgrade >= 99 && item.id != 828) {
            this.c.p.sendAddchatYellow("Thú cưỡi đã đạt cấp tối đa");
            return false;
        } else {
            ...
            if (isuplv) {
                ...
                if (lv == 10 || lv == 20 || lv == 30 || lv == 40 || lv == 50 || lv == 60 || lv == 70 || lv == 80 || lv == 90 || lv == 100 || lv == 110) {
                    byte j;
                    Option op2;
    ...
    public void getMobMe() {
        if (this.c.get().ItemBody[10] != null) {
            switch (this.c.get().ItemBody[10].id) {
                ...
                case 835: {
                    this.mobMeMessage(150, (byte) 0);
                    break;
                }
                case 836: {
                    this.mobMeMessage(73, (byte) 0);
                    break;
                }
                case 837: {
                    this.mobMeMessage(57, (byte) 0);
                    break;
                }
            }
        } else {
        ...
        if (this.c.clone.ItemBody[10] != null) {
            switch (this.c.clone.ItemBody[10].id) {
                ...
                case 833:
                    ...
                    break;
                case 834:
                    this.mobMeCloneMessage(201, (byte) 1);
                    break;
                case 835:
                    this.mobMeCloneMessage(150, (byte) 0);
                    break;
                case 836:
                    this.mobMeCloneMessage(73, (byte) 0);
                    break;
                case 837:
                    this.mobMeCloneMessage(57, (byte) 0);
                    break;
            }
        } else {
    ...
    public void PhiLoi() {
        if (this.c.philoi == 0) {
            this.conn.sendMessageLog("Hãy cày đi mang đủ thứ mà ta cần đến ta sẽ dạy ngươi bí thuật của ta");
        } else if (this.c.philoi == 1) {
            this.conn.sendMessageLog("Bạn đã học phi lôi thần thuật cấp 1\n Khi PK: \n Có 5% đặt dấu ấn lên kẻ địch khiến chúng không thể di chuyển trong 1,5 giây\n Đồng thời dịch chuyển đến phía sau và gây thêm 10.000 dame lên kẻ địch khi PK");
        } else if (this.c.philoi == 2) {
            this.conn.sendMessageLog("Bạn đã học phi lôi thần thuật cấp 2\n Khi PK: \n Có 7% đặt dấu ấn lên kẻ địch khiến chúng không thể di chuyển trong 1,5 giây\n Đồng thời dịch chuyển đến phía sau và gây thêm 10.000 dame lên kẻ địch");
        } else if (this.c.philoi == 3) {
            this.conn.sendMessageLog("Bạn đã học phi lôi thần thuật cấp 3\n Khi PK: \n Có 10% đặt dấu ấn lên kẻ địch khiến chúng không thể di chuyển trong 1,5 giây\n Đồng thời dịch chuyển đến phía sau và gây thêm 10.000 dame lên kẻ địch");
        } else if (this.c.philoi == 4) {
            this.conn.sendMessageLog("Bạn đã học phi lôi thần thuật cấp 4\n Khi PK: \n Có 100% đặt dấu ấn lên kẻ địch khiến chúng không thể di chuyển trong 1,5 giây\n Đồng thời dịch chuyển đến phía sau và gây thêm x10 dame lên kẻ địch");
        }
    }

    public void Hiennhan() {
        if (this.c.lvhnt == 0) {
            this.conn.sendMessageLog("Mày chưa học chiêu hiền nhân nên kém vl");
        } else if (this.c.lvhnt == 1) {
            this.conn.sendMessageLog("Bạn đang tu luyện hiền nhân thuật đến tầng 1\n Hiệu ứng đang nhận được là: \n +5000 dame lên quái\n Ma cà rồng: 1% tỷ lệ xuất hiện hút máu từ quái - tương đương 10% dame\n Mình đồng da sắt: giảm 300 sát thương từ quái\n Khiên miễn thương: 1% kích hoạt khiên miễn giảm toàn bộ sát thương từ quái");
        } else if (this.c.lvhnt == 2) {
            this.conn.sendMessageLog("Bạn đang tu luyện hiền nhân thuật đến tầng 2\n Hiệu ứng đang nhận được là: \n +7000 dame lên quái\n Ma cà rồng: 2% tỷ lệ xuất hiện hút máu từ quái - tương đương 10% dame\n Mình đồng da sắt: giảm 400 sát thương từ quái\n Khiên miễn thương: 2% kích hoạt khiên miễn giảm toàn bộ sát thương từ quái");
        } else if (this.c.lvhnt == 3) {
            this.conn.sendMessageLog("Bạn đang tu luyện hiền nhân thuật đến tầng 3\n Hiệu ứng đang nhận được là: \n +9000 dame lên quái\n Ma cà rồng: 3% tỷ lệ xuất hiện hút máu từ quái - tương đương 10% dame\n Giàu có: 3% nhận được 2 lượng khi đánh quái\n Mình đồng da sắt: giảm 500 sát thương từ quái\n Khiên miễn thương: 3% kích hoạt khiên miễn giảm toàn bộ sát thương từ quái");
        } else if (this.c.lvhnt == 4) {
            this.conn.sendMessageLog("Bạn đang tu luyện hiền nhân thuật đến tầng 4\n Hiệu ứng đang nhận được là: \n +11000 dame lên quái\n Ma cà rồng: 4% tỷ lệ xuất hiện hút máu từ quái - tương đương 10% dame\n Giàu có: 4% nhận được 2 lượng khi đánh quái\n Mình đồng da sắt: giảm 600 sát thương từ quái\n Khiên miễn thương: 4% kích hoạt khiên miễn giảm toàn bộ sát thương từ quái");
        } else if (this.c.lvhnt == 5) {
            this.conn.sendMessageLog("Bạn đang tu luyện hiền nhân thuật đến tầng 5\n Hiệu ứng đang nhận được là: \n +13000 dame lên quái\n Ma cà rồng: 5% tỷ lệ xuất hiện hút máu từ quái - tương đương 10% dame\n Giàu có: 5% nhận được 2 lượng khi đánh quái\n Mình đồng da sắt: giảm 700 sát thương từ quái\n Khiên miễn thương: 5% kích hoạt khiên miễn giảm toàn bộ sát thương từ quái");
        } else if (this.c.lvhnt == 6) {
            this.conn.sendMessageLog("Bạn đang tu luyện hiền nhân thuật đến tầng 6\n Hiệu ứng đang nhận được là: \n +15000 dame lên quái\n Ma cà rồng: 6% tỷ lệ xuất hiện hút máu từ quái - tương đương 10% dame\n Giàu có: 6% nhận được 2 lượng khi đánh quái\n Mình đồng da sắt: giảm 800 sát thương từ quái\n Khiên miễn thương: 6% kích hoạt khiên miễn giảm toàn bộ sát thương từ quái");
        } else if (this.c.lvhnt == 7) {
            this.conn.sendMessageLog("Bạn đang tu luyện hiền nhân thuật đến tầng 7\n Hiệu ứng đang nhận được là: \n +18000 dame lên quái\n Ma cà rồng: 7% tỷ lệ xuất hiện hút máu từ quái - tương đương 10% dame\n Giàu có: 7% nhận được 2 lượng khi đánh quái\n Mình đồng da sắt: giảm 900 sát thương từ quái\n Khiên miễn thương: 7% kích hoạt khiên miễn giảm toàn bộ sát thương từ quái");
        } else if (this.c.lvhnt == 8) {
            this.conn.sendMessageLog("Bạn đang tu luyện hiền nhân thuật đến tầng 8\n Hiệu ứng đang nhận được là: \n +21000 dame lên quái\n Ma cà rồng: 8% tỷ lệ xuất hiện hút máu từ quái - tương đương 10% dame\n Giàu có: 8% nhận được 2 lượng khi đánh quái\n Mình đồng da sắt: giảm 1100 sát thương từ quái\n Khiên miễn thương: 8% kích hoạt khiên miễn giảm toàn bộ sát thương từ quái");
        } else if (this.c.lvhnt == 9) {
            this.conn.sendMessageLog("Bạn đang tu luyện hiền nhân thuật đến tầng cuối cùng\n Hiệu ứng đang nhận được là: \n +25000 dame lên quái\n Ma cà rồng: 10% tỷ lệ xuất hiện hút máu từ quái - tương đương 10% dame\n Giàu có: 10% nhận được 2 lượng khi đánh quái\n Mình đồng da sắt: giảm 1300 sát thương từ quái\n Khiên miễn thương: 10% kích hoạt khiên miễn giảm toàn bộ sát thương từ quái");
        }
    }

    public void BachHaoThuat() {
        if (this.c.lvbht == 0) {
            this.conn.sendMessageLog("Mày còn kém lắm chưa đủ trình học bách hào thuật của ta đâu");
        } else if (this.c.lvbht == 1) {
            this.conn.sendMessageLog("Bạn đang tu luyện bách hào thuật đến tầng 1\n Hiệu ứng đang nhận được là: \n +1000 dame lên người\n 1% tỷ lệ xuất hiện bạo kích, x2 dame lên đối thủ khi pk");
        } else if (this.c.lvbht == 2) {
            this.conn.sendMessageLog("Bạn đang tu luyện bách hào thuật đến tầng 2\n Hiệu ứng đang nhận được là: \n +2000 dame lên người\n 2% tỷ lệ xuất hiện bạo kích, x2 dame lên đối thủ khi pk");
        } else if (this.c.lvbht == 3) {
            this.conn.sendMessageLog("Bạn đang tu luyện bách hào thuật đến tầng 3\n Hiệu ứng đang nhận được là: \n +3000 dame lên người\n 3% tỷ lệ xuất hiện bạo kích, x2 dame lên đối thủ khi pk");
        } else if (this.c.lvbht == 4) {
            this.conn.sendMessageLog("Bạn đang tu luyện bách hào thuật đến tầng 4\n Hiệu ứng đang nhận được là: \n +4000 dame lên người\n 4% tỷ lệ xuất hiện bạo kích, x2 dame lên đối thủ khi pk");
        } else if (this.c.lvbht == 5) {
            this.conn.sendMessageLog("Bạn đang tu luyện bách hào thuật đến tầng 5\n Hiệu ứng đang nhận được là: \n +5000 dame lên người\n 5% tỷ lệ xuất hiện bạo kích, x2 dame lên đối thủ khi pk");
        } else if (this.c.lvbht == 6) {
            this.conn.sendMessageLog("Bạn đang tu luyện bách hào thuật đến tầng 6\n Hiệu ứng đang nhận được là: \n +6000 dame lên người\n 6% tỷ lệ xuất hiện bạo kích, x2 dame lên đối thủ khi pk");
        } else if (this.c.lvbht == 7) {
            this.conn.sendMessageLog("Bạn đang tu luyện bách hào thuật đến tầng 7\n Hiệu ứng đang nhận được là: \n +7000 dame lên người\n 7% tỷ lệ xuất hiện bạo kích, x2 dame lên đối thủ khi pk");
        } else if (this.c.lvbht == 8) {
            this.conn.sendMessageLog("Bạn đang tu luyện bách hào thuật đến tầng 8\n Hiệu ứng đang nhận được là: \n +8000 dame lên người\n 8% tỷ lệ xuất hiện bạo kích, x2 dame lên đối thủ khi pk");
        } else if (this.c.lvbht == 9) {
            this.conn.sendMessageLog("Bạn đã tu luyện bách hào thuật đến tầng cuối cùng\n Hiệu ứng đang nhận được là: \n +10000 dame lên người\n 10% tỷ lệ xuất hiện bạo kích, x2 dame lên đối thủ khi pk");
        }
    }
