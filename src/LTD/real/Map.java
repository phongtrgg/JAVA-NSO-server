...
public class Map {
    public static int[] arrLang = new int[] { 10, 17, 22, 32, 38, 43, 48, 164};
     public static int[] arrlangvip = new int[] { 10, 17, 22, 32, 38, 43, 48 };
    public static int[] arrTruong = new int[] { 1, 27, 72 };
    public static int[] arrLangCo = new int[] { 134, 135, 136, 137,138};
            ...
            if (i == area) {
                ...
                for (j = 0; j < tileMap.mobs.size(); ++j) {
                    ...
                    if (mob != null && mob.status == 0 && mob.isboss) {
                        ...
                        System.out.println("Boss: " + mob.templates.name +" map :"+ tileMap.map.id +" khu :"+tileMap.id);
                    }
                }
                break;
            }
    ...
    public boolean LTDMap() {
        return this.id == 165;
    }
    public boolean LTDMap2() {
        return this.id == 166;
    }
