...
public class Body {
    ...
    public int getMaxHP() {
        int hpmax = (int) this.getPotential(2) * 10;
        if (this.Side() == 0) {
            hpmax = (int) this.getPotential(0) * 7;
        }
    ...
    public int getMaxMP() {
        int mpmax = (int) this.getPotential(3) * 10;
    ...
    public int eff5buffHP() {
        return (int) (this.getPramItem(30) + this.getPramItem(120));
    }

    public int eff5buffMP() {
        return (int) (this.getPramItem(27) + this.getPramItem(119));
    }
    ...
    public int speed() {
        int sp = this.speed;
        sp = (int) (sp * (100 + this.getPramItem(16)) / 100);
    ...
    public long dameSide() {
        ...
        if (this.Side() == 1) {
            ...
            si = this.getPotential(0) * 150 / 100;
            si += si * (this.getPramSkill(0) + this.getPramItem(8) + percent) / 100;
            si += this.getPramItem(0);
        }
    ...
    public long dameSys() {
        ...
        if (this.Sys() == 0) {
            ...
            if (this.Side() == 5) {
                ds += this.getPramSkill(75);
                ds += this.getPramItem(135);
            }
        } else if (this.Sys() == 1) {
    ...
    public long dameDown() {
        long dwn = this.getPramItem(47);//giam sat thuong cua itembody
    ...
    public int ResFire() {
        int bear = (int) this.getPramItem(2);
    ...
    public int ResIce() {
        int bear = (int) this.getPramItem(3);
    ...
    public int ResWind() {
        int bear = (int) this.getPramItem(4);
    ...
    public int Exactly() { //tn chính xác
        int exa = (int) (this.getPotential(1) * 150 / 100);
        if (this.Side() == 2 || this.Side() == 3) {
            exa = (int) this.getPotential(1) * 120 / 100;
        }
    ...
    public int Miss() { // tn né
        int miss = 0;
        if (this.c.get().getEffId(11) != null) {
            miss += this.c.get().getEffId(11).param;
        } else if (this.Side() == 2 || this.Side() == 3) {
            miss = (int) (this.getPotential(1) * 120 / 100);
        } else {
    ...
    public int FantalDame() {
        ...
        if (this.c.leveltutien > 10) {
            if (Util.nextInt(100) < (this.c.leveltutien)) {
                return (int) (this.getPramItem(105) * 3);
            }
        }
        return (int) this.getPramItem(105);
    }
    ...
    public int percentFire2() {
        ...
        return (int) this.getPramSkill(24);
    }
    ...
    public int percentFire4() {
        ...
        return (int) this.getPramSkill(34);
    }
    ...
    public int percentIce1_5() {
        ...
        return (int) this.getPramSkill(25);
    ...
    public int percentWind1() {
        ...
        return (int) this.getPramSkill(26);
    }
    ...
    public int percentWind2() {
        ...
        return (int) this.getPramSkill(36);
    }
    ...
    public int percentIce() {
        return (int) this.getPramSkill(69);
    }

    public int timeIce() {
        return (int) this.getPramSkill(70);
    }

    public int percentIce3() {
        return (int) this.getPramSkill(35);
    }
