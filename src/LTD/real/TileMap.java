...
public class TileMap {
        ...
        for (i = 0; i < arNinja.length; ++i) {
            ...
            if (fightChar != null) {
                if (fightChar.get().percentIce() >= Util.nextInt(1, 100)) {
                    ...
                    if (p.c.lvbang == 1 && tile <= 5) {
                        fightChar.p.setEffect(6, 0, 1500, 0);
                        p.sendAddchatYellow("băng phong");
                        fightChar.p.sendAddchatYellow("Bạn vừa dính hiệu ứng băng phong");
                    }
                    if (p.c.lvbang == 2 && tile <= 6) {
                        fightChar.p.setEffect(6, 0, 1500, 0);
                        p.sendAddchatYellow("băng phong");
                        fightChar.p.sendAddchatYellow("Bạn vừa dính hiệu ứng băng phong");
                    }
                    if (p.c.lvbang == 3 && tile <= 7) {
                        fightChar.p.setEffect(6, 0, 1500, 0);
                        p.sendAddchatYellow("băng phong");
                        fightChar.p.sendAddchatYellow("Bạn vừa dính hiệu ứng băng phong");
                    }
                    if (p.c.lvhoa == 1 && tile <= 5) {
                        fightChar.p.setEffect(5, 0, 2000, 0);
                        p.sendAddchatYellow("Hỏa vũ");
                        fightChar.p.sendAddchatYellow("Bạn vừa dính hiệu ứng hỏa vũ");
                    }
                    if (p.c.lvhoa == 2 && tile <= 7) {
                        fightChar.p.setEffect(5, 0, 2000, 0);
                        p.sendAddchatYellow("Hỏa vũ");
                        fightChar.p.sendAddchatYellow("Bạn vừa dính hiệu ứng hỏa vũ");
                    }
                    if (p.c.lvhoa == 3 && tile <= 10) {
                        fightChar.p.setEffect(5, 0, 2000, 0);
                        p.sendAddchatYellow("Hỏa vũ");
                        fightChar.p.sendAddchatYellow("Bạn vừa dính hiệu ứng hỏa vũ");
                    }
                    if (p.c.philoi == 1 && tile <= 5) {
                        dame += 10000;
                        this.setXYPlayers(fightChar.get().x, fightChar.get().y, p, fightChar.p);
                        fightChar.p.setEffect(18, 0, 3000, 0);
                    }
                    if (p.c.philoi == 2 && tile <= 7) {
                        dame += 10000;
                        this.setXYPlayers(fightChar.get().x, fightChar.get().y, p, fightChar.p);
                        fightChar.p.setEffect(18, 0, 3000, 0);
                    }
                    if (p.c.philoi == 3 && tile <= 10) {
                        dame += 10000;
                        this.setXYPlayers(fightChar.get().x, fightChar.get().y, p, fightChar.p);
                        fightChar.p.setEffect(18, 0, 3000, 0);
                    }
                    if (p.c.philoi == 4 && tile <= 100) {
                        dame *= 2;
                        this.setXYPlayers(fightChar.get().x, fightChar.get().y, p, fightChar.p);
                        fightChar.p.setEffect(18, 0, 3000, 0);
                    }
                    ...
                    boolean ismienst = mienst > Util.nextInt(1, 300);
                    if (ismienst) {
                        dame = 0;
                    ...
                    boolean ismiss = miss > Util.nextInt(1, 10000);
                    if (ismiss) {
                        dame = 0;
                    }
                    if (miss <= 0) {
    ...
    public long handleAfterAttackMob(Mob mob3, Char _char, long xpup) {
        if (mob3 != null && _char != null) {
            long dame = _char.get().dameMax();
            dame -= (dame*Util.nextInt(10))/100;
            int tile = Util.nextInt(1, 130);
            int nequai = 0;
            ...
            //né quái
            int miss = nequai - _char.get().Exactly();
            boolean ismiss = miss > Util.nextInt(1, 10000);
            if (ismiss) {
                dame = 0;
            }
            ...
            if (isfatal) {
                ...
                dame += _char.get().FantalDame() + _char.c.getPramItem(105);
            }
            //Phượng hoàng băng
            if (_char.getPramItem(130) >= Util.nextInt(1, 300)) {
                for (int l = 0; l < this.players.size(); ++l) {
                    GameCanvas.addEffect(this.players.get((int) l).conn, (byte) 1, mob3.id, (short) 65, 1, 1, false);
                    dame += 100000;
                }
            }
            if (dame <= 0) {
            ...
            if (this.map.cave != null || (mob3.level > 1 && Math.abs(mob3.level - _char.get().level) <= 10)) {
                ...
                if (this.map.LangCo()) {
                    ...
                    xpnew *= 2;
                } else if (_char.isNhanban) {
                    xpnew *= 2;
                } else if (_char.level > 99) {
                    xpnew /= 2;
                } else if (_char.nclass == 0) {
                    xpnew *= 4;
                }
                if (xpnew < 0) {
                    xpnew = Integer.MAX_VALUE;
                }
                xpup += (long) xpnew;
            }
            ...
            if (_char.lvhnt == 1) {
                dame += 5000;
                if (tile <= 1) {
                    _char.get().upHP((int) (_char.dameMax() * 110 / 100));
                }
            } else if (_char.lvhnt == 2) {
                dame += 7000;
                if (tile <= 2) {
                    _char.get().upHP((int) (_char.dameMax() * 110 / 100));
                }
            } else if (_char.lvhnt == 3) {
                dame += 9000;
                if (tile <= 3) {
                    _char.get().upHP((int) (_char.dameMax() * 110 / 100));
                }
            ...
            if (_char.lvbang == 1 && tile <= 5) {
                this.IceMobMessage(mob3.id, 0);
            }
            if (_char.lvbang == 2 && tile <= 6) {
                this.IceMobMessage(mob3.id, 0);
            }
            if (_char.lvbang == 3 && tile <= 7) {
                this.IceMobMessage(mob3.id, 0);
            }
            if (_char.lvhoa == 1 && tile <= 5) {
                this.FireMobMessage(mob3.id, 0);
            }
            if (_char.lvhoa == 2 && tile <= 7) {
                this.FireMobMessage(mob3.id, 0);
            }
            if (_char.lvhoa == 3 && tile <= 10) {
                this.FireMobMessage(mob3.id, 0);
            }
            ...
            if (mob3.isDie) {
                ...
                for (master = _char.veff.size() - 1; master >= 0; --master) {
                    ...
                    if (eff.template.type == 5) {
                        i = Util.nextInt((int) _char.get().dameMin(), (int) _char.get().dameMax());
    ...
    public void attached(int dame, int nid) {
        Message m = null;
        try {
                            ...
                            if (player.c.buNhin != null && this.buNhins.contains(player.c.buNhin) && Math.abs(player.c.buNhin.x - mob.x) <= 150 && Math.abs(player.c.buNhin.y - mob.y) <= 60) {
                                ...
                                if (Math.abs(player.c.get().x - mob.x) < dx && Math.abs(player.c.get().y - mob.y) < dy) {
                                    if (player.c.lvhnt == 1) {
                                        ...
                                        if (tile <= 1) {
                                            dame = 0;
                                            player.sendAddchatYellow("Miễn Thương");
                                        }
                                    } else if (player.c.lvhnt == 2) {
                                        dame -= 400;
                                        if (tile <= 1) {
                                            dame = 0;
                                            player.sendAddchatYellow("Miễn Thương");
                                        }
                                    } else if (player.c.lvhnt == 3) {
                                        dame -= 500;
                                        if (tile <= 2) {
                                            dame = 0;
                                            player.sendAddchatYellow("Miễn Thương");
                                        }
                                    } else if (player.c.lvhnt == 4) {
                                        dame -= 600;
                                        if (tile <= 2) {
                                            dame = 0;
                                            player.sendAddchatYellow("Miễn Thương");
                                        }
                                    } else if (player.c.lvhnt == 5) {
                                        dame -= 700;
                                        if (tile <= 3) {
                                            dame = 0;
                                            player.sendAddchatYellow("Miễn Thương");
                                        }
                                    } else if (player.c.lvhnt == 6) {
                                        dame -= 800;
                                        if (tile <= 4) {
                                            dame = 0;
                                            player.sendAddchatYellow("Miễn Thương");
                                        }
                                    } else if (player.c.lvhnt == 7) {
                                        dame -= 900;
                                        if (tile <= 6) {
                                            dame = 0;
                                            player.sendAddchatYellow("Miễn Thương");
                                        }
                                    } else if (player.c.lvhnt == 8) {
                                        dame -= 1100;
                                        if (tile <= 6) {
                                            dame = 0;
                                            player.sendAddchatYellow("Miễn Thương");
                                        }
                                    } else if (player.c.lvhnt == 9) {
                                        dame -= 1300;
                                        if (tile <= 7) {
                                            dame = 0;
                                            player.sendAddchatYellow("Miễn Thương");
                                    ...
                                    int phan12 = 100000;
                                    if (player.c.getPramItem(131) >= Util.nextInt(1, 300)) {
                                        for (int l = 0; l < this.players.size(); ++l) {
                                            GameCanvas.addEffect(this.players.get((int) l).conn, (byte) 1, mob.id, (short) 64, 1, 1, false);
                                            if (!mob.isDie && mob.hp > 0) {
                                                mob.updateHP(-phan12, player.c.id, true);
                                            }
                                    ...
                                    if (mob.isboss) {
                                        ...
                                        if (player.c.get().percentIce() >= Util.nextInt(1, 100)) {
                                            ...
                                            if (this.map.id == 165 && player.c.getEffId(44) == null) {
                                                switch (mob.sys) {
                                                    case 1:
                                            ...
                                            if (this.map.id == 166 && player.c.getEffId(44) == null) {
                                                switch (mob.sys) {
                                                    case 1:
        ...
        for (i = this.players.size() - 1; i >= 0; i--) {
            ...
            if (p != null && p.c != null) {
                ...
                if (p.c.timeKickSession <= System.currentTimeMillis()) {
                    ...
                    for (byte j = 0; j < p.c.get().ItemBody.length; j++) {
                        Item item = p.c.get().ItemBody[j];
                        if (item != null && item.id == 902 && p.c.philoi <= 3) {
                            for (k = this.players.size() - 1; k >= 0; k--) {;
                                GameCanvas.addEffect((this.players.get(k)).conn, (byte) 0, p.c.get().id, (short) 0, 0, 0, false);
                            }
                        }
                    }
                    for (byte j = 0; j < p.c.get().ItemBody.length; j++) {
                        Item item = p.c.get().ItemBody[j];
                        if (item != null && item.id == 913) {
                            for (k = this.players.size() - 1; k >= 0; k--) {;
                                GameCanvas.addEffect((this.players.get(k)).conn, (byte) 0, p.c.get().id, (short) 103, 1000, 1000, true);
                            }

                        }
                    }
                    if (p.role == 9999 && System.currentTimeMillis() > p.c.delayEffect) {
                        p.c.delayEffect = System.currentTimeMillis() + 3000L;
                        for (k = this.players.size() - 1; k >= 0; --k) {
                            GameCanvas.addEffect(this.players.get((int) k).conn, (byte) 0, p.c.get().id, (short) 148, 5000, 0, false);
                        }
                    }
                    if (p.c.lvhnt == 9 && System.currentTimeMillis() > p.c.delayEffect) {
                        p.c.delayEffect = System.currentTimeMillis() + 3000L;
                        for (k = this.players.size() - 1; k >= 0; --k) {
                            GameCanvas.addEffect(this.players.get((int) k).conn, (byte) 0, p.c.get().id, (short) 1, 0, 0, false);
                        }
                    }
                    for (byte j = 0; j < p.c.get().ItemBody.length; j++) {
                        Item item = p.c.get().ItemBody[j];
                        if (item != null && item.id == 930) {
                            for (k = this.players.size() - 1; k >= 0; k--) {;
                    ...
                    for (byte j = 0; j < p.c.get().ItemBody.length; j++) {
                        Item item = p.c.get().ItemBody[j];
                        if (item != null && item.id == 931) {
                            for (k = this.players.size() - 1; k >= 0; k--) {;
                                GameCanvas.addEffect((this.players.get(k)).conn, (byte) 0, p.c.get().id, (short) 95, 5000, 0, false);
                            }
                    ...
                    for (byte j = 0; j < p.c.get().ItemBody.length; j++) {
                        ...
                        if (item != null && item.id == 932) {
                            for (k = this.players.size() - 1; k >= 0; k--) {;
                                GameCanvas.addEffect((this.players.get(k)).conn, (byte) 0, p.c.get().id, (short) 151, 5000, 0, false);
                            }
                    ...
                    for (byte j = 0; j < p.c.get().ItemBody.length; j++) {
                        Item item = p.c.get().ItemBody[j];
                        if (item != null && item.id == 933) {
                            for (k = this.players.size() - 1; k >= 0; k--) {;
                                GameCanvas.addEffect((this.players.get(k)).conn, (byte) 0, p.c.get().id, (short) 152, 5000, 0, false);
                            }
                    ...
                    for (byte j = 0; j < p.c.get().ItemBody.length; j++) {
                        Item item = p.c.get().ItemBody[j];
                        if (item != null && item.id == 934) {
                            for (k = this.players.size() - 1; k >= 0; k--) {;
                                GameCanvas.addEffect((this.players.get(k)).conn, (byte) 0, p.c.get().id, (short) 153, 5000, 0, false);
                            }
                    ...
                    for (byte j = 0; j < p.c.get().ItemBody.length; j++) {
                        Item item = p.c.get().ItemBody[j];
                        if (item != null && item.id == 935) {
                            for (k = this.players.size() - 1; k >= 0; k--) {;
                                GameCanvas.addEffect((this.players.get(k)).conn, (byte) 0, p.c.get().id, (short) 154, 5000, 0, false);
                            }
                    ...
                    for (byte j = 0; j < p.c.get().ItemBody.length; j++) {
                        Item item = p.c.get().ItemBody[j];
                        if (item != null && item.id == 936) {
                            for (k = this.players.size() - 1; k >= 0; k--) {;
                                GameCanvas.addEffect((this.players.get(k)).conn, (byte) 0, p.c.get().id, (short) 155, 5000, 0, false);
                            }
                    ...
                    for (byte j = 0; j < p.c.get().ItemBody.length; j++) {
                        Item item = p.c.get().ItemBody[j];
                        if (item != null && item.id == 937) {
                            for (k = this.players.size() - 1; k >= 0; k--) {;
                                GameCanvas.addEffect((this.players.get(k)).conn, (byte) 0, p.c.get().id, (short) 156, 5000, 0, false);
                            }
                    ...
                    for (byte j = 0; j < p.c.get().ItemBody.length; j++) {
                        Item item = p.c.get().ItemBody[j];
                        if (item != null && item.id == 938) {
                            for (k = this.players.size() - 1; k >= 0; k--) {;
                                GameCanvas.addEffect((this.players.get(k)).conn, (byte) 0, p.c.get().id, (short) 157, 5000, 0, false);
                            }
                    ...
                    for (byte j = 0; j < p.c.get().ItemBody.length; j++) {
                        Item item = p.c.get().ItemBody[j];
                        if (item != null && item.id == 939) {
                            for (k = this.players.size() - 1; k >= 0; k--) {;
                                GameCanvas.addEffect((this.players.get(k)).conn, (byte) 0, p.c.get().id, (short) 158, 5000, 0, false);
                            }
                    ...
                    for (byte j = 0; j < p.c.get().ItemBody.length; j++) {
                        Item item = p.c.get().ItemBody[j];
                        if (item != null && item.id == 940) {
                            for (k = this.players.size() - 1; k >= 0; k--) {;
                                GameCanvas.addEffect((this.players.get(k)).conn, (byte) 0, p.c.get().id, (short) 159, 5000, 0, false);
                            }
                    ...
                    for (byte j = 0; j < p.c.get().ItemBody.length; j++) {
                        Item item = p.c.get().ItemBody[j];
                        if (item != null && item.id == 941) {
                            for (k = this.players.size() - 1; k >= 0; k--) {;
                                GameCanvas.addEffect((this.players.get(k)).conn, (byte) 0, p.c.get().id, (short) 160, 5000, 0, false);
                            }
                    ...
                    for (byte j = 0; j < p.c.get().ItemBody.length; j++) {
                        Item item = p.c.get().ItemBody[j];
                        if (item != null && item.id == 942) {
                            for (k = this.players.size() - 1; k >= 0; k--) {;
                                GameCanvas.addEffect((this.players.get(k)).conn, (byte) 0, p.c.get().id, (short) 161, 5000, 0, false);
                            }
                    ...
                    for (byte j = 0; j < p.c.get().ItemBody.length; j++) {
                        ...
                        if (item != null && item.id == 943) {
                            for (k = this.players.size() - 1; k >= 0; k--) {;
                                GameCanvas.addEffect((this.players.get(k)).conn, (byte) 0, p.c.get().id, (short) 162, 5000, 0, false);
                            }
                    ...
                    for (byte j = 0; j < p.c.get().ItemBody.length; j++) {
                        Item item = p.c.get().ItemBody[j];
                        if (item != null && item.id == 944) {
                            for (k = this.players.size() - 1; k >= 0; k--) {;
                                GameCanvas.addEffect((this.players.get(k)).conn, (byte) 0, p.c.get().id, (short) 163, 5000, 0, false);
                            }
                    ...
                    for (byte j = 0; j < p.c.get().ItemBody.length; j++) {
                        Item item = p.c.get().ItemBody[j];
                        if (item != null && item.id == 945) {
                            for (k = this.players.size() - 1; k >= 0; k--) {;
                                GameCanvas.addEffect((this.players.get(k)).conn, (byte) 0, p.c.get().id, (short) 164, 5000, 0, false);
                            }
                    ...
                    for (byte j = 0; j < p.c.get().ItemBody.length; j++) {
                        Item item = p.c.get().ItemBody[j];
                        if (item != null && item.id == 946) {
                            for (k = this.players.size() - 1; k >= 0; k--) {;
                                GameCanvas.addEffect((this.players.get(k)).conn, (byte) 0, p.c.get().id, (short) 120, 5000, 0, false);
                            }
                    ...
                    for (byte j = 0; j < p.c.get().ItemBody.length; j++) {
                        Item item = p.c.get().ItemBody[j];
                        if (item != null && item.id == 947) {
                            for (k = this.players.size() - 1; k >= 0; k--) {;
                                GameCanvas.addEffect((this.players.get(k)).conn, (byte) 0, p.c.get().id, (short) 165, 5000, 0, false);
                            }
                    ...
                    for (byte j = 0; j < p.c.get().ItemBody.length; j++) {
                        Item item = p.c.get().ItemBody[j];
                        if (item != null && item.id == 948) {
                            for (k = this.players.size() - 1; k >= 0; k--) {;
                                GameCanvas.addEffect((this.players.get(k)).conn, (byte) 0, p.c.get().id, (short) 166, 5000, 0, false);
                            }
                    ...
                    for (byte j = 0; j < p.c.get().ItemBody.length; j++) {
                        Item item = p.c.get().ItemBody[j];
                        if (item != null && item.id == 949) {
                            for (k = this.players.size() - 1; k >= 0; k--) {;
                                GameCanvas.addEffect((this.players.get(k)).conn, (byte) 0, p.c.get().id, (short) 167, 5000, 0, false);
                            }
                    ...
                    for (byte j = 0; j < p.c.get().ItemBody.length; j++) {
                        Item item = p.c.get().ItemBody[j];
                        if (item != null && item.id == 950) {
                            for (k = this.players.size() - 1; k >= 0; k--) {;
                                GameCanvas.addEffect((this.players.get(k)).conn, (byte) 0, p.c.get().id, (short) 168, 5000, 0, false);
                            }
                    ...
                    for (byte j = 0; j < p.c.get().ItemBody.length; j++) {
                        Item item = p.c.get().ItemBody[j];
                        if (item != null && item.id == 951) {
                            for (k = this.players.size() - 1; k >= 0; k--) {;
                                GameCanvas.addEffect((this.players.get(k)).conn, (byte) 0, p.c.get().id, (short) 169, 5000, 0, false);
                            }
                    ...
                    for (byte j = 0; j < p.c.get().ItemBody.length; j++) {
                        Item item = p.c.get().ItemBody[j];
                        if (item != null && item.id == 952) {
                            for (k = this.players.size() - 1; k >= 0; k--) {;
                                GameCanvas.addEffect((this.players.get(k)).conn, (byte) 0, p.c.get().id, (short) 170, 5000, 0, false);
                            }
                    ...
                    for (byte j = 0; j < p.c.get().ItemBody.length; j++) {
                        ...
                        if (item != null && item.id == 953) {
                            for (k = this.players.size() - 1; k >= 0; k--) {;
                                GameCanvas.addEffect((this.players.get(k)).conn, (byte) 0, p.c.get().id, (short) 171, 5000, 0, false);
                            }
                    ...
                    for (byte j = 0; j < p.c.get().ItemBody.length; j++) {
                        Item item = p.c.get().ItemBody[j];
                        if (item != null && item.id == 954) {
                            for (k = this.players.size() - 1; k >= 0; k--) {;
                                GameCanvas.addEffect((this.players.get(k)).conn, (byte) 0, p.c.get().id, (short) 172, 5000, 0, false);
                            }

                        }
                    }
                    if (p.role == 990 && System.currentTimeMillis() > p.c.delayEffect) {
                        p.c.delayEffect = System.currentTimeMillis() + 3000L;
                        for (k = this.players.size() - 1; k >= 0; --k) {
                            GameCanvas.addEffect(this.players.get((int) k).conn, (byte) 0, p.c.get().id, (short) 102, 1, 0, true);
                        }
                    }
                    if (p.role == 991 && System.currentTimeMillis() > p.c.delayEffect) {
                        p.c.delayEffect = System.currentTimeMillis() + 3000L;
                        for (k = this.players.size() - 1; k >= 0; --k) {
                            GameCanvas.addEffect(this.players.get((int) k).conn, (byte) 0, p.c.get().id, (short) 105, 1, 0, true);
                        }
                    }
                    if (p.role == 992 && System.currentTimeMillis() > p.c.delayEffect) {
                        p.c.delayEffect = System.currentTimeMillis() + 3000L;
                        for (k = this.players.size() - 1; k >= 0; --k) {
                            GameCanvas.addEffect(this.players.get((int) k).conn, (byte) 0, p.c.get().id, (short) 106, 1, 0, true);
                        }
                    }
                    if (p.role == 993 && System.currentTimeMillis() > p.c.delayEffect) {
                        p.c.delayEffect = System.currentTimeMillis() + 3000L;
                        for (k = this.players.size() - 1; k >= 0; --k) {
                            GameCanvas.addEffect(this.players.get((int) k).conn, (byte) 0, p.c.get().id, (short) 107, 1, 0, true);
                        }
                    }
                    if (p.role == 994 && System.currentTimeMillis() > p.c.delayEffect) {
                        p.c.delayEffect = System.currentTimeMillis() + 3000L;
                        for (k = this.players.size() - 1; k >= 0; --k) {
                            GameCanvas.addEffect(this.players.get((int) k).conn, (byte) 0, p.c.get().id, (short) 108, 1, 0, true);
                        }
                    }
                    if (p.role == 995 && System.currentTimeMillis() > p.c.delayEffect) {
                        p.c.delayEffect = System.currentTimeMillis() + 3000L;
                        for (k = this.players.size() - 1; k >= 0; --k) {
                            GameCanvas.addEffect(this.players.get((int) k).conn, (byte) 0, p.c.get().id, (short) 109, 1, 0, true);
                        }
                    }
                    if (p.c.isGiftTDB == 0) {
                        switch (p.c.rankTDB) {
                        ...
                        if (this.itemMap.get(i).itemMapId == itemmapid) {
                            ...
                            if (data.type == 21 || data.type == 19 || p.c.getBagNull() > 0 || (p.c.getIndexBagid(item.id, item.isLock) != -1 && data.isUpToUp)) {
                                ...
                                if (ItemTemplate.ItemTemplateId(item.id).type == 19) {
                                    ...
                                    p.c.get().upHP((int) p.c.getPramSkill(50));
                                }
                                m.writer().flush();
                                p.conn.sendMessage(m);
                                m.cleanup();
