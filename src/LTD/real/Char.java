...
import LTD.thiendiabang.ThienDiaBangTileMap;
...
public class Char extends Body {
    ...
    public void setXPLoadSkill(long exp) {
        ...
        try {
            ...
            m.writer().writeShort((short)this.get().spoint);
            m.writer().writeShort((short)this.get().ppoint);
            m.writer().writeShort((short)this.get().potential0);
            m.writer().writeShort((short)this.get().potential1);
            m.writer().writeInt((int)this.get().potential2);
            m.writer().writeInt((int)this.get().potential3);
            m.writer().flush();
    ...
    public boolean addItemBag(Boolean uptoup, Item itemup) {
        try {
            ...
            if (uptoup.booleanValue() && !itemup.isExpires && ItemTemplate.ItemTemplateId((int) itemup.id).isUpToUp && index != -1) {
                Item item = this.ItemBag[index];
                if (item.quantity >= 50000) {
                    this.p.conn.sendMessageLog("Số lượng item đã đầy không thể nhận thêm nữa");
                    return false;
                }
    ...
    public void removeItemBag() throws SQLException { //vu huy dat
        byte i;
        for (i = 0; i < this.ItemBag.length; ++i) {
    ...
    public synchronized void removeItemBag(byte index) throws SQLException {
        Item item = this.getIndexBag(index);
        if (item != null) {
            try {
                Message m = new Message(18);
    ...
    public boolean checkNoiNgoai(byte nclass) {
        if (nclass == 0 || nclass == 1 || nclass == 3 || nclass == 5| nclass == 8| nclass == 9) {
            return true;
        }
        return false;
    }
        ...
        try {
            synchronized (Server.LOCK_MYSQL) {
                ...
                if (red != null && red.first()) {
                    ...
                    nja.lvhnt = red.getInt("lvhnt");
                    nja.exphnt = red.getLong("exphnt");
                    nja.lvbht = red.getInt("lvbht");
                    nja.expbht = red.getLong("expbht");
                    nja.lvbang = red.getInt("lvbang");
                    nja.lvhoa = red.getInt("lvhoa");
                    nja.philoi = red.getInt("philoi");
                    nja.numquai = red.getInt("numquai");
                    nja.latthe = red.getInt("latthe");
                    nja.numtl = red.getInt("numtl");
                    nja.nhiemvu = red.getInt("nhiemvu");
                    nja.bingo = red.getInt("bingo");
                    ...
                    nja.topgiaikhac = red.getLong("topgiaikhac");
                    nja.pointEvent = red.getInt("pointEvent");
                    nja.coin = red.getLong("coin");
                    nja.dame = red.getLong("dame");
                    nja.sohoanhan = red.getLong("sohoanhan");
                    ...
                    if (ma != null && (ma.getXHD() != -1 || ma.LangCo() || ma.mapBossTuanLoc() || ma.mapLDGT() || ma.mapGTC() || ma.id == 111 || ma.id == 113)) {
                        nja.mapLTD = 22;
                    }
    ...
    public void flush() {
        ...
        try {
            synchronized (Server.LOCK_MYSQL) {
                ...
                sqlSET = sqlSET + ",`timeRemoveClone` = " + this.timeRemoveClone + ",`isHangDong6x` = " + this.isHangDong6x + ",`ldgtID` = " + this.ldgtID + ",`pointBossTL` = " + this.pointBossTL + ",`maxPointCT` = " + this.isTakePoint + ",`clan`='" + jarr.toJSONString() + "',`denbu`=" + this.denbu + ",`newlogin`='" + Util.toDateString(this.newlogin) + "',`ddClan`=" + this.ddClan + ",`caveID`=" + this.caveID + ",`nCave`=" + this.nCave + ",`pointCave`=" + this.pointCave + ",`useCave`=" + this.useCave + ",`bagCaveMax`=" + this.bagCaveMax + ",`itemIDCaveMax`=" + this.itemIDCaveMax + ",`saveBXH`=" + this.saveBXH + ",`exptype`=" + this.exptype + ",`luongTN`=" + this.luongTN + ",`expCS`=" + this.expCS + ",`coin`=" + this.coin + ",`chuyenSinh`=" + this.chuyenSinh + ",`diemhoado`=" + this.diemhoado + ",`diemhoavang`=" + this.diemhoavang + ",`diemhoaxanh`=" + this.diemhoaxanh + ",`diemhoa`=" + this.diemhoa + ",`exphnt`=" + this.exphnt + ",`nvtruyentin`=" + this.nvtruyentin + ",`pointEvent` = " + this.pointEvent + ",`lvhnt`=" + this.lvhnt + ",`sk10thang3`=" + this.sk10thang3 + ",`matkhauatm`=" + this.matkhauatm + ",`qmkatm`=" + this.qmkatm + ",`topgiaikhac`=" + this.topgiaikhac + ",`exphnt`=" + this.exphnt + ",`expbht`=" + this.expbht + ",`lvbht`=" + this.lvbht + ",`lvbang`=" + this.lvbang + ",`lvhoa`=" + this.lvhoa + ",`pointBossChuot`=" + this.pointBossChuot + ",`philoi`=" + this.philoi + ",`numquai`=" + this.numquai + ",`latthe`=" + this.latthe + ",`numtl`=" + this.numtl + ",`nhiemvu`=" + this.nhiemvu + ",`bingo`=" + this.bingo + ",`tntrung`=" + this.tntrung + ",`kntrung`=" + this.kntrung + ",`dame`=" + p.c.dameMax() + ",`sohoanhan`=" + this.sohoanhan +"";
