...
public class CloneCharacter extends Body {
    ...
    public void setXPLoadSkill(long exp) {
        ...
        try {
            ...
            m.writer().writeShort((short)this.spoint);
            m.writer().writeShort((short)this.ppoint);
            m.writer().writeShort((short)this.potential0);
            m.writer().writeShort((short)this.potential1);
