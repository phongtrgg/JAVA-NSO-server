    ...
    public void loginGame(Message m) {
        try {
            ...
            if (p != null && (Util.CheckString(passw, "^[a-zA-Z0-9]+$"))) {
               ...
               System.err.println("NSOBlow Login - socket size: " + Client.gI().conns_size() + " - Tài Khoản: " + p.username + " - Tên NV : " + p.ninja + " - ip: " + this.clientIpAddress + " - phien ban : " + this.versionARM 
                       +"\n----------------------------------------------------------");
